        ...
        <div class="header-meta d-flex clearfix justify-content-end">
            ...
            <div class="search-area">
                <form action="{{ route('search') }}" method="get">
                    <input type="search" name="query" id="headerSearch" placeholder="Nhập từ khóa">
            ...
            <div class="user-login-info">
                @if (Auth::check()) 
                <a href="{{route('logout')}}"><img src="{{ asset('img/core-img/logout.svg') }}" alt=""></a>
                {{Auth::user()->name}}
                @else
                <a href="{{route('loginForm')}}"><img src="{{ asset('img/core-img/user.svg') }}" alt=""></a>
                @endif
            </div>
